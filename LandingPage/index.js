...
function openVideo(){
    console.log("openVideo called"); // Debug log
    ...
    if (videoBg && videoContainer) {
        ...
        document.body.classList.add("modal-open")
        console.log("Video opened successfully"); // Debug log
    } else {
        console.error("Video elements not found"); // Error log
    }
}

function closeVideo(){
    console.log("closeVideo called"); // Debug log
    ...
    if (videoBg && videoContainer) {
        ...
        document.body.classList.remove("modal-open")
        console.log("Video closed successfully"); // Debug log
    } else {
        console.error("Video elements not found"); // Error log
    }
}
